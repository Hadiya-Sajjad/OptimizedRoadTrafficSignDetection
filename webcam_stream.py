...
# Enter Camera Index 0: webcam. if it doesn't show camera stream on 0 try 1,2 or 3.
camera_index = 0
        ...
        for out in outs:
            for detection in out:
                ...
                if confidence > 0.5:
                    ...
                    cv2.putText(resized_frame, recognized_class, (left, top - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255),
                                2)
